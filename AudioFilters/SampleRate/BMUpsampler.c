...
#define BM_UPSAMPLER_STAGE0_TRANSITION_BANDWIDTH 0.25
#define BM_UPSAMPLER_STOPBAND_ATTENUATION_DB 110.0
#define BM_UPSAMPLER_SECOND_STAGE_AA_FILTER_NUMLEVELS 5
#define BM_UPSAMPLER_SECOND_STAGE_AA_FILTER_FC 22500.0
