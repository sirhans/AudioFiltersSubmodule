...
enum delayTimeMethod {DTM_VELVETNOISE, DTM_RANDOM, DTM_RELATIVEPRIME, DTM_LOGVELVETNOISE, DTM_UNIQUESUMS, DTM_RANDOMPRIMES, DTM_SCALEDPRIMES, DTM_PSEUDORANDOM, DTM_RANDOMFIXEDTOTAL};
